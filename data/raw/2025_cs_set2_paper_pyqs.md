...
**Topic**: Computer Science
**Question**:
Q.3 If 𝑃𝑒𝑥 = 𝑄𝑒−𝑥 for all real values of 𝑥, which one of the following statements is 
true? 
...
(B) 𝑝1𝑝2 is not a prime number. 
(C) 𝑝1 + 𝑝2 + 1 is a prime number. 
(D) 𝑝1𝑝2 + 1 is a prime number. 
...
**Question**:
Q.11 If 𝐴 = (1 2
2 −1), then which ONE of the following is 𝐴8 ? 
...
**Topic**: Computer Science
**Question**:
Q.12 The value of 𝑥 such that 𝑥 > 1, satisfying the equation ∫ 𝑡 ln 𝑡 𝑑𝑡 =
𝑥
1   is 
...
## Question GATE-PYQ-021: Computer Networks
**Topic**: Computer Networks
**Question**:
...
## Question GATE-PYQ-022: Computer Networks
**Topic**: Computer Networks
**Question**:
...
## Question GATE-PYQ-028: Theory of Computation
**Topic**: Theory of Computation
**Question**:
Q.24 Which ONE of the following languages is accepted by a deterministic push down 
automaton?  
...
## Question GATE-PYQ-029: Theory of Computation
**Topic**: Theory of Computation
**Question**:
...
## Question GATE-PYQ-030: Operating Systems
...
## Question GATE-PYQ-032: Operating Systems
**Topic**: Operating Systems
**Question**:
...
## Question GATE-PYQ-034: Theory of Computation
**Topic**: Theory of Computation
**Question**:
...
## Question GATE-PYQ-043: Algorithms
**Topic**: Algorithms
**Question**:
...
Which ONE of the following options gives t he worst-case time complexities for 
...
## Question GATE-PYQ-044: Computer Organization and Architecture
...
## Question GATE-PYQ-045: Compiler Design
...
## Question GATE-PYQ-046: Algorithms
**Topic**: Algorithms
**Question**:
...
(A) 𝑤̅𝑥̅𝑦̅𝑧̅ + 𝑤𝑥̅𝑦̅𝑧̅ + 𝑤̅𝑥̅𝑦𝑧̅ + 𝑤𝑥̅𝑦𝑧̅ + 𝑥𝑧   
(B) 𝑤̅𝑥̅𝑦̅𝑧̅ + 𝑤̅𝑥̅𝑦𝑧̅ + 𝑤𝑥̅𝑦𝑧 + 𝑥𝑧  
(C) 𝑤̅𝑥̅𝑦̅𝑧̅ + 𝑤𝑥̅𝑦̅𝑧̅ + 𝑤𝑥̅𝑦̅𝑧 + 𝑥𝑧  
(D) 𝑥̅𝑧̅ + 𝑥𝑧  
...
## Question GATE-PYQ-051: Database Management Systems
...
## Question GATE-PYQ-053: Operating Systems
**Topic**: Operating Systems
**Question**:
Q.48 
 
𝑃 = {𝑃1, 𝑃2, 𝑃3, 𝑃4} consists of all active processes in an operating system.  
...
**Topic**: Computer Science
**Question**:
Q.49 Three floating point numbers 𝑋, 𝑌, and 𝑍 are stored in three registers R X, RY, and 
...
(C) (𝐴 +  𝐶) (𝐴̅  + 𝐵)  =  𝐴 𝐵 + 𝐴̅ 𝐶  
(D) (𝐴 +  𝐵̅  + 𝐷̅) (𝐶 + 𝐷) (𝐴̅  +  𝐶 + 𝐷 ) (𝐴 +  𝐵 +  𝐷̅)̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅  =  𝐴̅ 𝐷 +  𝐶̅ 𝐷̅   
...
## Question GATE-PYQ-060: Operating Systems
**Topic**: Operating Systems
**Question**:
...
**Topic**: Operating Systems
**Question**:
Q.58 A computer system supports a logical address space of 2 32 bytes. It uses two-level 
...
## Question GATE-PYQ-065: Theory of Computation
**Topic**: Theory of Computation
**Question**:
...
## Question GATE-PYQ-066: Computer Organization and Architecture
**Topic**: Computer Organization and Architecture
**Question**:
...
Instruction type Clock cycles required per 
instruction (CPI) 
...
invariant if (𝑥 −  𝛼)(𝑥 − 𝛽) = (𝑥 − 𝛼2)(𝑥 − 𝛽2). Suppose from the set of all 
