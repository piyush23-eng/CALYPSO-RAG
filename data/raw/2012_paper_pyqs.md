...
printed at the right hand top corner of this page does not matc h with the Booklet Code on the ORS, 
...
4. This Question Booklet contains 20 pages including blank pages fo r rough work. After you are 
...
against the question number. For each question darken the bubble of the correct ans wer. More 
...
11. Rough work can be done on the question paper itself. Blank pages are provided at the end o f the
...
**Topic**: Computer Science
**Question**:
Q.11  Let A be the 2 × 2 matrix with elements a 11 = a12 = a21 = +1 and a 22 = −1. Then the eigenvalues of 
the matrix A19  are 
...
## Question GATE-PYQ-021: Database Management Systems
...
## Question GATE-PYQ-022: Database Management Systems
**Topic**: Database Management Systems
**Question**:
...
## Question GATE-PYQ-023: Algorithms
**Topic**: Algorithms
**Question**:
...
## Question GATE-PYQ-027: Operating Systems
**Topic**: Operating Systems
**Question**:
...
## Question GATE-PYQ-029: Computer Networks
...
## Question GATE-PYQ-040: Operating Systems
**Topic**: Operating Systems
**Question**:
...
## Question GATE-PYQ-042: Computer Networks
**Topic**: Computer Networks
**Question**:
...
index variables, respectively. Initially, REA R = FRONT = 0. The conditions to detect queue full 
and queue empty are  
...
## Question GATE-PYQ-047: Algorithms
**Topic**: Algorithms
**Question**:
...
## Question GATE-PYQ-048: Algorithms
**Topic**: Algorithms
**Question**:
...
any iteration, the shortest pat h to a vertex v is updated only when a strictly shorter path to v is 
discovered. 
...
size of 3 page frames which are initially empt y. Let LRU, FIFO and OPTIMAL denote the number 
...
**Topic**: Computer Science
**Question**:
Q.43  Suppose R 1(A, B) and R 2(C, D) are two relation  schemas. Let r1 and r2 be the corresponding 
...
**Topic**: Computer Science
**Question**:
Q.44  Consider a source computer (S) transmitting a file of size 10 6 bits to a destination computer (D) 
over a network of two routers (R 1 and R2) and three links (L 1, L2, and L 3). L1 connects S to R 1; L2 
connects R 1 to R 2; and L 3 connects R 2 to D. Let e ach link be of length 100 km. Assume signals 
...
## Question GATE-PYQ-053: Computer Networks
**Topic**: Computer Networks
**Question**:
...
## Question GATE-PYQ-058: Database Management Systems
**Topic**: Database Management Systems
**Question**:
...
## Question GATE-PYQ-059: Database Management Systems
**Topic**: Database Management Systems
**Question**:
...
**Topic**: Computer Science
**Question**:
Q.56  The cost function for a product in a firm is given by 5q2, where q is the amount of production. The 
...
**Topic**: Computer Science
**Question**:
Q.60  Choose the most appropriate alternative from the options given below to comple te the following 
sentence: 
...
**Topic**: Computer Science
**Question**:
Q.61  Wanted Temporary, Part-time persons for the post of Field Interviewer to conduct persona l 
...
being held. The profile o f the arch follows the equation y = 2x – 0.1x2 where y is the height of the 
...
## Question GATE-PYQ-073: Computer Science
**Topic**: Computer Science
**Question**:
...
## Question GATE-PYQ-075: Computer Science
**Topic**: Computer Science
**Question**:
