...
nor other branches. The number of students who like their core branches is 1/4 th of 
...
## Question GATE-PYQ-009: Operating Systems
...
## Question GATE-PYQ-015: Operating Systems
**Topic**: Operating Systems
**Question**:
Q.11 
...
## Question GATE-PYQ-019: Algorithms
**Topic**: Algorithms
**Question**:
...
Which one of the following options is the CORRECT value of ∫ 𝑓(𝑥)𝑑𝑥
0  ? 
...
**Topic**: Computer Science
**Question**:
Q.18 When s ix unbiased dice are rolled simultaneously , the probability of getting all 
...
relationship 
(D) Neither weak entity set nor owner entity set MUST have total participation in the 
...
## Question GATE-PYQ-026: Theory of Computation
...
## Question GATE-PYQ-028: Operating Systems
**Topic**: Operating Systems
**Question**:
...
(D) Raise a trap when a process tries to write to a page marked with read-only 
...
## Question GATE-PYQ-029: Operating Systems
**Topic**: Operating Systems
**Question**:
...
## Question GATE-PYQ-030: Algorithms
**Topic**: Algorithms
**Question**:
...
**Topic**: Operating Systems
**Question**:
Q.27 Which of the following statements about the T wo Phase Locking (2PL) protocol 
is/are TRUE? 
  
(A) 2PL permits only serializable schedules 
(B) With 2PL, a transaction always locks the data item being read or written just 
before every operation and always releases the lock just after the operation 
(C) With 2PL, once a lock is released on any data item inside a transaction, no more 
...
(D) The reassembly of fragments is performed at all intermediate routers along the 
...
## Question GATE-PYQ-033: Compiler Design
**Topic**: Compiler Design
**Question**:
Q.29 Which of the following statements is/are FALSE? 
  
(A) An attribute grammar is a syntax-directed definition (SDD) in which the functions 
in the semantic rules have no side effects 
(B) The attributes in a L -attributed definition cannot always be e valuated in a depth -
first order 
(C) Synthesized attributes can be evaluated by a bottom-up parser as the input is parsed 
(D) All L -attributed definitions based on LR(1) grammar can be evaluated using a 
...
## Question GATE-PYQ-035: Operating Systems
**Topic**: Operating Systems
**Question**:
...
## Question GATE-PYQ-036: Computer Networks
**Topic**: Computer Networks
**Question**:
...
(B) Assuming a character array c is declared as char c[] = ”abcd” in main(), 
...
## Question GATE-PYQ-039: Algorithms
**Topic**: Algorithms
**Question**:
...
**Topic**: Computer Networks
**Question**:
Q.38 Which one of the following CIDR prefixes exactly represents the range of  
...
## Question GATE-PYQ-050: Database Management Systems
...
## Question GATE-PYQ-051: Operating Systems
**Topic**: Operating Systems
**Question**:
Q.46 
...
obtained from 𝐴 by swapping two rows. Which of the following statements is/are 
TRUE? 
...
(D) In each cycle 𝐶 in 𝐺, either all edges in 𝐶 have even weight OR all edges in 𝐶 
have odd weight
...
## Question GATE-PYQ-059: Computer Networks
**Topic**: Computer Networks
**Question**:
...
**Topic**: Computer Science
**Question**:
Q.55 Consider a n Ethernet segment with a transmission speed of 10 8 bits/sec and a 
...
## Question GATE-PYQ-061: Database Management Systems
**Topic**: Database Management Systems
**Question**:
...
## Question GATE-PYQ-063: Computer Organization and Architecture
**Topic**: Computer Organization and Architecture
**Question**:
...
20% instructions incur an average of 2 cycle s stall due to data hazards and  
20% instructions incur an average of 3 cycle s stall due to control hazards. The 
...
Let 𝑍𝑛 be the group of integers {0, 1, 2, … , 𝑛 − 1} with addition modulo 𝑛 as the 
...
## Question GATE-PYQ-069: Operating Systems
**Topic**: Operating Systems
**Question**:
Q.64 Consider a 32-bit system with 4 KB page size and page table entries of size 4 bytes 
each. Assume 1 K B = 2 10 bytes. The OS uses a 2 -level page table for memory 
...
creation. The OS uses demand paging when allocating m emory for the inner page 
...
## Question GATE-PYQ-070: Compiler Design
**Topic**: Compiler Design
**Question**:
