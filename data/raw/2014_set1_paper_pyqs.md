...
**Topic**: Computer Science
**Question**:
Q.4  If (𝑧𝑧 + 1/𝑧𝑧)2 = 98, compute (𝑧𝑧2 + 1/𝑧𝑧2).
...
**Topic**: Computer Science
**Question**:
Q.5  The roots of 𝑎𝑎𝑥𝑥2 + 𝑏𝑏𝑥𝑥 + 𝑐𝑐 = 0 are real and positive. a, b and c are real. Then 𝑎𝑎𝑥𝑥2 + 𝑏𝑏|𝑥𝑥| + 𝑐𝑐 = 0 
has 
...
addition, groups of 4 or more get a discount of 5% o n the total fare.  If the one way single person 
...
further asked to mention whether they own a car or scooter or both. The ir responses are tabulated 
...
Predicate )ݔ(ݏݎ݁ݐݐ݈݅݃is true if ݔglitters and predicate )ݔ(݈݀݋݃is true if ݔis gold. Which one of 
the following logical formulae represents the above statement?
    
(A) )ݔ(݈݀݋݃  
B) )ݔ(ݏݎ݁ݐݐ݈݅݃⇒ )ݔ( ݈݀݋݃   :ݔ  
C) )ݔ(ݏݎ݁ݐݐ݈݅݃  
D) )ݔ(݈݀݋݃
...
**Topic**: Computer Science
**Question**:
Q.2 Suppose you break a stick of unit length at a point chosen uniformly at random. Then the expected 
...
**Topic**: Computer Science
**Question**:
Q.3 Let G=(V,E) be a directed graph where V is the set of vertices and E the set of edges. Then which 
one of the following graphs has the same strongly connected components as G ? 
(A) ଵ) where } 
(B)ଶ) where } 
(C) ଷ) where ≤ 2݂}  
(D) )ܧ where ସ is the set of vertices in ܩwhich are not isolated
...
**Topic**: Computer Science
**Question**:
Q.5 The value of the dot product of the eigenvectors corresponding to any pair of different eigenvalues 
...
଺ ,
గ
ଷቃ and )ߠ(′݂denote the derivative of ݂with respect to  .ߠWhich of the following 
...
ܲ+ܳܲ=)ܵ,ܴ,ܳ,ܲ(ܨ തܲ+ܴܳ തܴܳതܵ 
 
The minimal sum-of-products form of F is  
 
(A) ܵܳ+ܴܳ+ܳܲ B)  ܵ+ܴ+ܳ+ܲC)   ܲതܳതܴതܵ̅ (D)   ܲതܲ+ܴതܴതܲ+ܵ
...
## Question GATE-PYQ-031: Algorithms
**Topic**: Algorithms
**Question**:
Q.15 Whic
(A) T
...
## Question GATE-PYQ-033: Computer Organization and Architecture
**Topic**: Computer Organization and Architecture
**Question**:
...
(D)20  is an example of common subexpression elimination.
...
## Question GATE-PYQ-035: Computer Organization and Architecture
**Topic**: Computer Organization and Architecture
**Question**:
...
**Topic**: Computer Science
**Question**:
Q.21 Consider the relation scheme ,ܫ,ܪ,ܩ,ܨ,ܧ(=ܴ ܬ)ܰ,ܯ,ܮ,ܭ, and the set of functional dependencies  
},  {F} ,ܫܬ } } on R. What is the key for 
R ?  
...
## Question GATE-PYQ-038: Database Management Systems
...
**Topic**: Computer Networks
**Question**:
Q.25 Identify the correct order in which the following actio ns take place in an interaction between a web 
...
station. The propagation speed of the signal is 2×1 0଼ m/s and the token transmission time is 
...
1.5 Mbps link with a one-way latency of 50 ms ec. To achieve a link utilization of 60%, the 
...
**Topic**: Computer Science
**Question**:
Q.35 Let ܮbe a language and ܮത be its complement. Which one of the following is NOT a viable 
possibility?   
(A) Neither ܮnor ܮത is recursively enumerable (r.e.). 
(B) One of ܮand ܮത is r.e. but not recursive; the other is not r.e. 
(C) Both ܮand ܮത are r.e. but not recursive. 
(D) Both ܮand ܮത are recursive.
...
## Question GATE-PYQ-053: Theory of Computation
...
**Topic**: Computer Science
**Question**:
Q.37 There are 5 bags labeled 1 to 5.  All the coins in  a given bag have the sa me weight.  Some bags 
...
**Topic**: Computer Science
**Question**:
Q.40 Consider a hash table with 9 slots.  The hash function is 9 .  The collisions are 
...
## Question GATE-PYQ-065: Computer Organization and Architecture
**Topic**: Computer Organization and Architecture
**Question**:
Q.48 Four
The v
...
**Topic**: Computer Science
**Question**:
Q.50 Let ܵdenote the set of all functions  ݂{0,1}ସ → {0,1}.  Denote by ܰthe number of   functions 
from ܵto the set  {0,1}. The value of  ܰis ______.
...
**Topic**: Computer Science
**Question**:
Q.51 Consider an undirected graph ܩwhere self-loops are not allowed. The vertex set of ܩis ,݆݅ 1 ≤
≤1 2 , 1≤݆≤1 2}. There is an edge between )ܾ,ܽ and )݀,ܿ if | ≤1  and | ≤1 . 
...
**Topic**: Computer Science
**Question**:
Q.52 An ordered ݊tuple ௡) with ௡ is called graphic if there exists a simple 
undirected graph with ݊vertices having degrees ௡ respectively. Which of the following 
...
**Topic**: Computer Science
**Question**:
Q.53 Which one of the following propo sitional logic formulas is TRUE when exactly two of ݌ ,ݍ ,and ݎ 
are TRUE?   
(A) )ݎ 
B) )ݎ  
C) )ݎ 
...
## Question GATE-PYQ-072: Operating Systems
**Topic**: Operating Systems
**Question**:
Q.55 Consider two processors ଵ and ଶ executing the same instruction set. Assume that under identical 
conditions, for the same input, a program running on ଶ takes 25% less time but incurs 20% more 
CPI (clock cycles per instruction) as compared to the program running on ଵ. If the clock frequency 
of ଵ is 1GHz, then the clock frequency of ଶ (in GHz) is _________.   
