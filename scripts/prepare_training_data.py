...
def extract_qa_pairs_from_pyq_file(file_path: Path) -> List[Dict[str, Any]]:
    ...
    for sec in sections[1:]:
        ...
        instruction = (
            f"You are LORCEN, an expert GATE Computer Science reasoning assistant. "
...
def generate_curated_syllabus_questions() -> List[Dict[str, Any]]:
    ...
    curated = [
        # OS
        {
            "instruction": "You are LORCEN, an expert GATE Computer Science reasoning assistant. Solve this Operating Systems problem with complete step-by-step mathematical derivation.",
        ...
        # DBMS
        {
            "instruction": "You are LORCEN, an expert GATE Computer Science reasoning assistant. Solve this DBMS concurrency control problem.",
        ...
        {
            "instruction": "You are LORCEN, an expert GATE Computer Science reasoning assistant. Solve this DBMS normalization problem.",
        ...
        # Algorithms
        {
            "instruction": "You are LORCEN, an expert GATE Computer Science reasoning assistant. Solve this Algorithms analysis problem.",
        ...
        {
            "instruction": "You are LORCEN, an expert GATE Computer Science reasoning assistant. Solve this Recurrence relation using Master Theorem.",
        ...
        # COA
        {
            "instruction": "You are LORCEN, an expert GATE Computer Science reasoning assistant. Solve this Computer Organization hard disk problem.",
        ...
        # Networks
        {
            "instruction": "You are LORCEN, an expert GATE Computer Science reasoning assistant. Solve this Computer Networks protocol problem.",
        ...
        # TOC
        {
            "instruction": "You are LORCEN, an expert GATE Computer Science reasoning assistant. Solve this Theory of Computation problem.",
        ...
        # Compiler
        {
            "instruction": "You are LORCEN, an expert GATE Computer Science reasoning assistant. Solve this Compiler Design syntax analysis problem.",
        ...
        {
            "instruction": "You are LORCEN, an expert GATE Computer Science reasoning assistant. Solve this Discrete Mathematics graph theory problem.",
        ...
        {
            "instruction": "You are LORCEN, an expert GATE Computer Science reasoning assistant. Solve this Discrete Mathematics relations problem.",
        ...
        {
            "instruction": "You are LORCEN, an expert GATE Computer Science reasoning assistant. Solve this Engineering Mathematics Linear Algebra problem.",
        ...
        {
            "instruction": "You are LORCEN, an expert GATE Computer Science reasoning assistant. Solve this Engineering Mathematics Probability problem.",
        ...
        # Digital Logic
        {
            "instruction": "You are LORCEN, an expert GATE Computer Science reasoning assistant. Solve this Digital Logic problem.",
        ...
        {
            "instruction": "You are LORCEN, an expert GATE Computer Science reasoning assistant. Solve this Digital Logic number representation problem.",
        ...
        {
            "instruction": "You are LORCEN, an expert GATE Computer Science reasoning assistant. Solve this Data Structures B+ Tree problem.",
        ...
        {
            "instruction": "You are LORCEN, an expert GATE Computer Science reasoning assistant. Solve this Data Structures AVL Tree problem.",
        ...
        # Networks
        {
            "instruction": "You are LORCEN, an expert GATE Computer Science reasoning assistant. Solve this Computer Networks sliding window problem.",
